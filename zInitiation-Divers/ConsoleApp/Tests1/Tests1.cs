...
namespace ConsoleApp
{
    public class Tests1
    {
                    ...
                    poConfig.CreateMap<TSource, TDesti>()
                     ...
                     .ForMember(poDesti => poDesti.seconds, opt => opt.MapFrom(poSource => poSource.dateTime.Second))
                      ...
                      .ForPath(poDesti => poDesti.oTypePerso.iChampX,
                            ...
                            ) //Utiliser ForPath au lieu de ForMember, lorsqu'on veut écrire une règle spécifique sur un chemin interne
                              //de l'objet Desti.
        ...
        private static List<Source2> _getSource2List()
        {
            List<Source2> oSource2List = new List<Source2> {
                new Source2
                {
                    ...
                    SomeInstances = new List<MaClasse>() {
                        new MaClasse { p1=10, p2="yes" },
                        new MaClasse { p1=100, p2="no" },
                    },
                },
                new Source2
                {
        ...
        {
            Console.WriteLine("\n\n\n===========  listConversion, conversion de (sous-)listes =============\n\n");

            List<Source2> oSource2List = _getSource2List();


            //--->>>>> Même les membres sous-sous-objets de Source2, seront automatiquement mappés vers Desti2 !    (ex.: membre SomeInstances)
